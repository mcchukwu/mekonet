				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					<div>
						<p className="mt-4 text-secondary-600 dark:text-secondary-400 max-w-md">
							Mekonet is revolutionizing car maintenance in Nigeria by
							connecting car owners with trusted mechanics nearby.
						</p>
						<div className="mt-6 flex items-center space-x-4">
							...
							<p className="text-secondary-700 dark:text-secondary-300 font-medium">
								Mobile App{" "}
								<span className="bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-300 text-xs px-2 py-0.5 rounded-full ml-2">
									Coming Soon
								</span>
							</p>
						</div>
